...
/*
 ...
 struct AvatarSelectionView: View {
     ...
     ///update avatar TODO:  minus award update logic
     /*   func calculateAvatar (part: AvatarPartType, category: AvatarCategory, position: Int) -> Avatar{
      var index = 0
 ...
 struct ConfirmationView: View {
     ...
     var body: some View {
         VStack {
             Text("Would you like to buy this avatar? It costs xxx coins")
             // Text("Current Avatar")
